...
- <img width="32" src="https://ccvaults.com/assets/20.%20Blocks/39.%20Admin/Command_Block.png" alt="Command Block" align="center"> **Admin** ex: graylist (modified from [Vane](https://github.com/oddlama/vane)): when new players join they need to be `/vouched <username>` by another user to break blocks, open doors, etc.; keeps logs of who vouched who
